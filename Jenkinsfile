pipeline {
    ...
    environment {
        ...
        DOCKER_IMAGE = 'cithit/clarkap2'                                                                    //<------your MiamiID
        IMAGE_TAG = "build-${BUILD_NUMBER}"
        GITHUB_URL = 'https://github.com/clarkap2/225-lab3-7'                                    //<------your MiamiID
        KUBECONFIG = credentials('clarkap2-225')                                                         //<------your MiamiID
    }
        ...
        stage ("Run Security Checks") {
            steps {
                ...
                sh '''
                    ...
                    -e BURP_START_URL=http://10.48.10.217 \
